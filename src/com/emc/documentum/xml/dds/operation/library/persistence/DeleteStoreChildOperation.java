...
import com.emc.documentum.xml.dds.operation.library.persistence.DeleteStoreChildOperationExecutable;
import com.emc.documentum.xml.dds.persistence.Store;
import com.emc.documentum.xml.dds.persistence.StoreChild;

public class DeleteStoreChildOperation
extends AbstractSingleStoreOperation<Object> {
    private final StoreChild storeChild;

    public DeleteStoreChildOperation(StoreChild storeChild) throws OperationException {
    ...
    public String getExecutableClassName() {
        return DeleteStoreChildOperationExecutable.class.getName();
    }
