...
import com.emc.documentum.xml.dds.operation.library.persistence.CopyStoreChildOperationExecutable;
import com.emc.documentum.xml.dds.persistence.Store;
import com.emc.documentum.xml.dds.persistence.StoreChild;

public class CopyStoreChildOperation
extends AbstractTwoStoreOperation<Object> {
    private final StoreChild source;
    private final StoreChild target;
    private final boolean replace;

    public CopyStoreChildOperation(StoreChild source, StoreChild target, boolean replace) throws OperationException {
    ...
    public String getExecutableClassName() {
        return CopyStoreChildOperationExecutable.class.getName();
    }
