...
public final class XAMXMLUtil {
    ...
    public static Node retrieveNode(XMLNode xmlNode) throws NodeNotFoundException, AmbiguousXPointerException, StoreSpecificException, DeadlockException {
        ...
        try {
            ...
            Node result = PersistenceUtil.retrieveXMLNode(new InputSource(is), xmlNode);
            is.close();
            return result;
        }
            ...
            throw new StoreSpecificException("A problem occurred retrieving the data :", ioe);
        }
    }
}
